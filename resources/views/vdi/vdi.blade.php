...
<head>
    ...
    <link href="{{ asset('css/bootstrap.min3.css') }}" rel="stylesheet">
...
<body>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="position-relative overflow-hidden h-100" style="min-height: 400px;">
                        ...
                        <img class="position-absolute top-0 end-0 bg-white ps-2 pb-2" src="img/about-2.jpg"
    ...
    <script src="vdii/wow/wow.min.js"></script>
    <script src="vdii/easing/easing.min.js"></script>
    <script src="vdii/waypoints/waypoints.min.js"></script>
    <script src="vdii/owlcarousel/owl.carousel.min.js"></script>
    <script src="vdii/parallax/parallax.min.js"></script>
